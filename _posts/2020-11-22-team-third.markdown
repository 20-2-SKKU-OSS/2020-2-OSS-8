...
<tr>
	<td><b>이진섭</b></td>
	<td>파이썬 버전에 의한 문제를 해결하고자 한다. 프로젝트의 진행사항(이슈 및 프로젝트보드)과<br>
	소스코드 분석을 통해 얻은 정보를 바탕으로 소스코드 추가 및 수정을 할 계획이다.<br>
	우선 issue에 올라오는 로그창을 통해 파이썬의 어느 모듈에서 충돌이 발생하는지 알아볼 것이다.</td>
  <td></td>	
</tr></table>
